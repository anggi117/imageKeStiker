                    ...
                    if (args.length == 2) {
                        ...
                        instagram(url)
                            .then(async(videoMeta) => {
                                ...
                                client.sendText(from, `Link Download:\n${content.join('\n')} \n\nDonasi: kamu dapat membantu creator utama beli dimsum dengan menyawer melalui https://saweria.co/donate/yogasakti atau mentrakteer melalui https://trakteer.id/red-emperor \nTerimakasih.`)
                            }).catch((err) => {
                                console.error(err)
